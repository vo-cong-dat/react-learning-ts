...
export default function Banner() {
  return (
    <>
      ...
      <div className="mx-4 bg-[#FF8D0A] -top-[76px] md:top-1/2 md:gap-x-[84px] flex-wrap md:-translate-y-1/2 md:mx-[120px] gap-4 p-6 flex flex-col md:flex-row md:items-center md:justify-between rounded-2xl md:px-10 relative">
        ...
        <div className="flex flex-col md:flex-row gap-3 flex-1">
          <Button className="w-full font-normal md:w-2/3" variant="secondary">
